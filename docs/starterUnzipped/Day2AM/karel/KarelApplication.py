...
class KarelApplication(tk.Frame):
	...
	def inject_namespace(self):
		...
		self.mod.girar_izquierda = self.karel_action_decorator(self.karel.turn_left)
		self.mod.moverse = self.karel_action_decorator(self.karel.move)
		self.mod.recoger_cono = self.beeper_action_decorator(self.karel.pick_beeper)
		self.mod.poner_cono = self.beeper_action_decorator(self.karel.put_beeper)
		self.mod.rumbo_norte = self.karel.facing_north
		self.mod.rumbo_sur = self.karel.facing_south
		self.mod.rumbo_este = self.karel.facing_east
		self.mod.rumbo_oeste = self.karel.facing_west
		self.mod.sin_rumbo_norte = self.karel.not_facing_north
		self.mod.sin_rumbo_sur = self.karel.not_facing_south
		self.mod.sin_rumbo_este = self.karel.not_facing_east
		self.mod.sin_rumbo_oeste = self.karel.not_facing_west
		self.mod.frente_despejado = self.karel.front_is_clear
		self.mod.conos_presentes = self.karel.beepers_present
		self.mod.conos_ausentes = self.karel.no_beepers_present
		self.mod.bolsa_con_conos = self.karel.beepers_in_bag
		self.mod.bolsa_sin_conos = self.karel.no_beepers_in_bag
		self.mod.frente_bloqueado  = self.karel.front_is_blocked
		self.mod.izquierda_despejada = self.karel.left_is_clear
		self.mod.izquierda_bloqueada = self.karel.left_is_blocked
		self.mod.derecha_despejada = self.karel.right_is_clear
		self.mod.derecha_bloqueada = self.karel.right_is_blocked
		self.mod.pintarEsquina = self.corner_action_decorator(self.karel.paint_corner)
		self.mod.esquina_color_es = self.karel.corner_color_is
		self.mod.aleatorio = KarelApplication.random
